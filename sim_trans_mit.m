...
experfinal_list = {['res_',experdef,'_bench']};
translabel='';
res_names = {['res_',experdef,'_bench',translabel] };
...
start_shock_sequence=[3];
start_ini=3;

shockcell.exst = 3;
shockcell.params = {'MITshockloss',0.05;};
shockcell.pts = {};
...
%        res_array= ['ST_',res_array_names{nexp},'_names'];
%        res_names=getfield(load(res_array,'res_array'),'res_array');
